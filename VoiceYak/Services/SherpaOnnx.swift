...
nonisolated func sherpaOnnxOnlineTransducerModelConfig(
  encoder: String = "",
  decoder: String = "",
  joiner: String = ""
...
nonisolated func sherpaOnnxOnlineParaformerModelConfig(
  encoder: String = "",
  decoder: String = ""
...
nonisolated func sherpaOnnxOnlineZipformer2CtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOnlineNemoCtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOnlineToneCtcModelConfig(
  model: String = ""
...
///
/// - Returns: Return an instance of SherpaOnnxOnlineTransducerModelConfig
nonisolated func sherpaOnnxOnlineModelConfig(
  tokens: String,
...
nonisolated func sherpaOnnxFeatureConfig(
...
nonisolated func sherpaOnnxOnlineCtcFstDecoderConfig(
  graph: String = "",
  maxActive: Int = 3000
...
nonisolated func sherpaOnnxHomophoneReplacerConfig(
  dictDir: String = "",
  lexicon: String = "",
  ruleFsts: String = ""
...
nonisolated func sherpaOnnxOnlineRecognizerConfig(
...
///
nonisolated class SherpaOnnxOnlineRecongitionResult {
...
nonisolated class SherpaOnnxRecognizer {
  /// A pointer to the underlying counterpart in C
...
nonisolated func sherpaOnnxOfflineTransducerModelConfig(
  encoder: String = "",
  decoder: String = "",
  joiner: String = ""
...
nonisolated func sherpaOnnxOfflineParaformerModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineZipformerCtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineWenetCtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineOmnilingualAsrCtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineMedAsrCtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineFireRedAsrCtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineNemoEncDecCtcModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineDolphinModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineWhisperModelConfig(
  encoder: String = "",
  decoder: String = "",
  language: String = "",
...
nonisolated func sherpaOnnxOfflineCanaryModelConfig(
  encoder: String = "",
  decoder: String = "",
  srcLang: String = "en",
  tgtLang: String = "en",
...
nonisolated func sherpaOnnxOfflineCohereTranscribeModelConfig(
  encoder: String = "",
  decoder: String = "",
  language: String = "",
  usePunct: Bool = true,
...
nonisolated func sherpaOnnxOfflineFireRedAsrModelConfig(
  encoder: String = "",
  decoder: String = ""
...
nonisolated func sherpaOnnxOfflineMoonshineModelConfig(
  preprocessor: String = "",
  encoder: String = "",
...
nonisolated func sherpaOnnxOfflineQwen3ASRModelConfig(
  convFrontend: String = "",
  encoder: String = "",
  decoder: String = "",
  tokenizer: String = "",
...
nonisolated func sherpaOnnxOfflineTdnnModelConfig(
  model: String = ""
...
nonisolated func sherpaOnnxOfflineSenseVoiceModelConfig(
  model: String = "",
  language: String = "",
...
nonisolated func sherpaOnnxOfflineLMConfig(
  model: String = "",
  scale: Float = 1.0
...
nonisolated func sherpaOnnxOfflineFunASRNanoModelConfig(
...
nonisolated func sherpaOnnxOfflineModelConfig(
  tokens: String,
...
nonisolated func sherpaOnnxOfflineRecognizerConfig(
  featConfig: SherpaOnnxFeatureConfig,
...
nonisolated class SherpaOnnxOfflineRecongitionResult {
  /// A pointer to the underlying counterpart in C
...
nonisolated class SherpaOnnxOfflineRecognizer {
  /// A pointer to the underlying counterpart in C
  private let recognizer: OpaquePointer
...
nonisolated class SherpaOnnxOfflineStreamWrapper {
...
nonisolated func sherpaOnnxSileroVadModelConfig(
  model: String = "",
  threshold: Float = 0.5,
...
nonisolated func sherpaOnnxTenVadModelConfig(
  model: String = "",
  threshold: Float = 0.5,
  minSilenceDuration: Float = 0.25,
  minSpeechDuration: Float = 0.5,
...
nonisolated func sherpaOnnxVadModelConfig(
...
nonisolated class SherpaOnnxCircularBufferWrapper {
...
nonisolated class SherpaOnnxSpeechSegmentWrapper {
...
nonisolated class SherpaOnnxVoiceActivityDetectorWrapper {
  /// A pointer to the underlying counterpart in C
...
// offline tts
nonisolated func sherpaOnnxOfflineTtsVitsModelConfig(
  model: String = "",
  lexicon: String = "",
  tokens: String = "",
  dataDir: String = "",
...
nonisolated func sherpaOnnxOfflineTtsMatchaModelConfig(
...
nonisolated func sherpaOnnxOfflineTtsKokoroModelConfig(
  model: String = "",
  voices: String = "",
  tokens: String = "",
  dataDir: String = "",
...
nonisolated func sherpaOnnxOfflineTtsKittenModelConfig(
  model: String = "",
  voices: String = "",
  tokens: String = "",
  dataDir: String = "",
...
nonisolated func sherpaOnnxOfflineTtsZipvoiceModelConfig(
  tokens: String = "",
  encoder: String = "",
  decoder: String = "",
  vocoder: String = "",
...
nonisolated func sherpaOnnxOfflineTtsPocketModelConfig(
  lmFlow: String = "",
  lmMain: String = "",
  encoder: String = "",
  decoder: String = "",
...
nonisolated func sherpaOnnxOfflineTtsSupertonicModelConfig(
...
nonisolated func sherpaOnnxOfflineTtsModelConfig(
...
nonisolated func sherpaOnnxOfflineTtsConfig(
...
nonisolated class SherpaOnnxWaveWrapper {
...
nonisolated class SherpaOnnxGeneratedAudioWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated class SherpaOnnxCallbackPair {
...
nonisolated struct SherpaOnnxGenerationConfigSwift {
...
nonisolated final class SherpaOnnxGenerationConfigC {
...
nonisolated class SherpaOnnxOfflineTtsWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated func sherpaOnnxSpokenLanguageIdentificationWhisperConfig(
  encoder: String,
  decoder: String,
  tailPaddings: Int = -1
...
nonisolated func sherpaOnnxSpokenLanguageIdentificationConfig(
...
nonisolated class SherpaOnnxSpokenLanguageIdentificationResultWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated class SherpaOnnxSpokenLanguageIdentificationWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated class SherpaOnnxKeywordResultWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated func sherpaOnnxKeywordSpotterConfig(
  featConfig: SherpaOnnxFeatureConfig,
  modelConfig: SherpaOnnxOnlineModelConfig,
  keywordsFile: String,
  maxActivePaths: Int = 4,
...
nonisolated class SherpaOnnxKeywordSpotterWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated func sherpaOnnxOfflinePunctuationModelConfig(
...
nonisolated func sherpaOnnxOfflinePunctuationConfig(
...
nonisolated class SherpaOnnxOfflinePunctuationWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated func sherpaOnnxOnlinePunctuationModelConfig(
  cnnBiLstm: String,
  bpeVocab: String,
  numThreads: Int = 1,
  debug: Int = 0,
...
nonisolated func sherpaOnnxOnlinePunctuationConfig(
...
nonisolated class SherpaOnnxOnlinePunctuationWrapper {
  /// A pointer to the underlying counterpart in C
  let ptr: OpaquePointer!
...
nonisolated func sherpaOnnxOfflineSpeakerSegmentationPyannoteModelConfig(model: String)
...
nonisolated func sherpaOnnxOfflineSpeakerSegmentationModelConfig(
...
nonisolated func sherpaOnnxFastClusteringConfig(numClusters: Int = -1, threshold: Float = 0.5)
  -> SherpaOnnxFastClusteringConfig
{
  return SherpaOnnxFastClusteringConfig(num_clusters: Int32(numClusters), threshold: threshold)
}

nonisolated func sherpaOnnxSpeakerEmbeddingExtractorConfig(
  model: String,
  numThreads: Int = 1,
  debug: Int = 0,
  provider: String = "cpu"
...
nonisolated func sherpaOnnxOfflineSpeakerDiarizationConfig(
...
nonisolated struct SherpaOnnxOfflineSpeakerDiarizationSegmentWrapper {
  var start: Float = 0
  var end: Float = 0
  var speaker: Int = 0
}

nonisolated class SherpaOnnxOfflineSpeakerDiarizationWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated class SherpaOnnxOnlineStreamWrapper {
  /// A pointer to the underlying counterpart in C
  let impl: OpaquePointer!
...
nonisolated class SherpaOnnxSpeakerEmbeddingExtractorWrapper {
  /// A pointer to the underlying counterpart in C
  let impl: OpaquePointer!
...
nonisolated func sherpaOnnxOfflineSpeechDenoiserGtcrnModelConfig(model: String = "")
...
nonisolated func sherpaOnnxOfflineSpeechDenoiserDpdfNetModelConfig(model: String = "")
...
nonisolated func sherpaOnnxOfflineSpeechDenoiserModelConfig(
...
nonisolated func sherpaOnnxOfflineSpeechDenoiserConfig(
...
nonisolated class SherpaOnnxDenoisedAudioWrapper {
  /// A pointer to the underlying counterpart in C
...
nonisolated class SherpaOnnxOfflineSpeechDenoiserWrapper {
  /// A pointer to the underlying counterpart in C
  let impl: OpaquePointer!
...
nonisolated func sherpaOnnxOnlineSpeechDenoiserConfig(
  model: SherpaOnnxOfflineSpeechDenoiserModelConfig =
    sherpaOnnxOfflineSpeechDenoiserModelConfig()
...
nonisolated class SherpaOnnxOnlineSpeechDenoiserWrapper {
  let impl: OpaquePointer!
...
nonisolated func getSherpaOnnxVersion() -> String {
  return String(cString: SherpaOnnxGetVersionStr())
}

nonisolated func getSherpaOnnxGitSha1() -> String {
  return String(cString: SherpaOnnxGetGitSha1())
}

nonisolated func getSherpaOnnxGitDate() -> String {
...
nonisolated struct SourceSeparationConfig {
  struct Spleeter {
    var vocals: String
...
nonisolated class SourceSeparator {
